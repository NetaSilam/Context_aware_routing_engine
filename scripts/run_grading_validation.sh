...
services=(
  ...
  forum-tests forum-security-tests forum-seed-tests messages-tests notifications-tests abuse-tests forum-abuse-tests gateway-tests e2e-tests stress-tests
)
